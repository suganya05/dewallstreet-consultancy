      ...
      <div className="mx">
        <div className="home_page">
          <div className="bg_video">
            ...
            <div className="dewall_heropage">
              <div className="dewall_logo">
                <img src={logo} alt="logo" />
              </div>
              <div className="">
                <h3>
                  We are the best professional service network for all your
                </h3>
              </div>
              ...
              <div>
                <p>
                  ...
                  ethically incorporated and regulated under the norms of
                  Ministry of Corporate Affairs (MCA) & Registrar of Companies
                  (RoC) and follows industrial reputation trust marks, quality
                  delivery standards, ethical business & market practices with
                  Go-Global bootstrapped principle.
                </p>
              </div>
            </div>
          </div>
